...
class ClientCreateCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('btn:oauth-server:client:create')
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf('Added a new client with name <info>%s</info> and public id <info>%s</info>.', 'cli', $client->getPublicId()));
    }
}